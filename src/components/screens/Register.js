                    ...
                    {({ handleSubmit }) => {
                        ...
                        return (
                            <View>
                                ...
                                <View className='flex-row items-center mt-[16px]'>
                                    <FormikInput name='email' placeholder="Escriba su correo electrónico" placeholderTextColor={'gray'} color='gray' className='bg-gray-100 rounded-sm p-[16px] w-full font-[LatoRegular]' />
                                    <View className='absolute right-0 p-[16px]'>
